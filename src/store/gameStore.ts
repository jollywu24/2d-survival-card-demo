...
const INITIAL_DISCOVERED_RECIPE_IDS = [
  ...
  'tap-coconut-water',
  'campfire-kit',
  'lit-tinder-with-knife',
  'lit-tinder-with-flint',
  'campfire',
  'beach-campfire',
  'kindled-campfire',
  'temporary-shelter',
...
const craftingRecipes: CraftingRecipe[] = [
  ...
  {
    id: 'lit-tinder-with-knife',
    name: '用石刀点火绒',
    description: '用石刀背和石片反复擦打，让火绒包里冒出第一点火星。',
    requires: [
      { itemId: 'campfire-kit', amount: 1 },
      { itemId: 'stone-knife', amount: 1 },
    ],
    preserves: [{ itemId: 'stone-knife', amount: 1 }],
    produces: [{ itemId: 'lit-tinder', amount: 1 }],
    category: 'tool',
  },
  {
    id: 'lit-tinder-with-flint',
    name: '用燧石点火绒',
    description: '燧石比石刀更可靠，几次敲击后火绒包终于带上了能救命的火星。',
    requires: [
      { itemId: 'campfire-kit', amount: 1 },
      { itemId: 'flint', amount: 1 },
    ],
    preserves: [{ itemId: 'flint', amount: 1 }],
    produces: [{ itemId: 'lit-tinder', amount: 1 }],
    category: 'tool',
  },
  {
  ...
  },
  {
    id: 'campfire',
    name: '搭建石圈篝火',
    description: '先用石块围出火圈，再把木棍和木材架成通风的火堆。它还没燃起来，但已经像回事了。',
    requires: [
    ...
    produces: [{ itemId: 'unlit-campfire', amount: 1 }],
    category: 'building',
  },
  {
    id: 'beach-campfire',
    name: '搭建海滩火堆',
    description: '没有大石块时，就用更多海滩小石子围出浅火圈，塞进木棍和干木材先搭好一个能点燃的火堆。',
    requires: [
      { itemId: 'pebble', amount: 4 },
      { itemId: 'stick', amount: 1 },
      { itemId: 'driftwood', amount: 1 },
    ],
    produces: [{ itemId: 'unlit-campfire', amount: 1 }],
  ...
  },
  {
    id: 'kindled-campfire',
    name: '点燃篝火',
    description: '把点燃的火绒塞进火堆深处，轻轻吹气，等木棍先接住火，再让整堆木材烧起来。',
    requires: [
      { itemId: 'unlit-campfire', amount: 1 },
      { itemId: 'lit-tinder', amount: 1 },
    ],
